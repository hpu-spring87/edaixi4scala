package com.edaixi.app4scala.likebutton;
...
public class LikeButtonView extends FrameLayout implements View.OnClickListener {
    ...
    LikeButtonClickListener likeButtonClickListener;
    ...
    public void onClick(View v) {
        isChecked = !isChecked;
        ivStar.setBackgroundResource(isChecked ? R.mipmap.main_btn : R.mipmap.main_btn);
        ...
        likeButtonClickListener.getVuttonClickListener(true);
    }
